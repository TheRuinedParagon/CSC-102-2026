 // this is our array/list of plants - add as many as you like
        ...
        function showPlants(){
            // clear out the ulPlants list before adding any more plants to it
            ulPlants.innerHTML = "";
            ...
            arrPlants.forEach(function(plant, index){
                ...
                li.onclick = function(){
                    ...
                    if (confirm("Remove " + plant + "?")){
                        // remove the plant from the array - remove from index
                        arrPlants.splice(index, 1);

                        // add a message that the plant was deleted
        ...
        function addPlant(){
            // get the text that the user entered into the addplant text box
            ...
            // let the user know the plant was added
            document.getElementById("divMessage").textContent = newPlant + " was added!";
            
            // erase the text from teh textbox
            document.getElementById("txtNewPlant").value = "";

            // we need to call showplants again so that we see the new plant on the page
            showPlants();
        }
